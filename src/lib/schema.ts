...
export const scrolls = sqliteTable("scroll", {
  ...
  rawResults: text("raw_results"), // JSON: intermediate search results for multi-step processing
...
export const papers = sqliteTable("paper", {
  ...
  imageKey: text("image_key"), // R2 object key for extracted figure (images/{scrollId}/{paperId}.png)
});
