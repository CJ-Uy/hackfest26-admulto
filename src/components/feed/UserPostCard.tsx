...
export function UserPostCard({
  ...
  return (
    <article
      className="border-border hover:bg-muted/50 cursor-pointer overflow-hidden border-b px-4 py-3 transition-colors"
      onClick={() => {
        onClearNewComment?.();
    ...
    >
      ...
      <p className="text-foreground line-clamp-4 text-[15px] leading-relaxed break-words whitespace-pre-wrap">
        {post.content}
      </p>
      {/* Reply notification */}
      ...
      {isGenerating && (
        <div className="bg-subtle mt-2 flex items-center gap-2 rounded-md px-3 py-2">
